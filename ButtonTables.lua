...
simpleButtons.ui[ [[RosiesGame,rosieStart,63]] ] = 
    {text = [[info]],
...
simpleButtons.ui[ [[Menu,rosieGreetingText,41]] ] = 
...
simpleButtons.ui[ [[stack traceback:
	...
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[x]],
    x = 0.062469497315764, y = 0.91666666666667,
    width = 93.764, height = 85.5702,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[uiPieces,choice,131+adventure]] ] = 
    {text = [[adventure]],
...
simpleButtons.ui[ [[stack traceback:
	SimpleButtons_B:269: in function 'button'
	uiPieces:11: in function 'simpleImage'
	CharlotteGame:197: in function 'charlotteStart'
	Main:37: in global '_wrap_draw'
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[coffee]],
    x = 0.50600292825769, y = 0.575,
    width = 90.4704, height = 76.1856,
    action = simpleButtons.defaultButtonAction
}

simpleButtons.ui[ [[uiPieces,textArea,120+Your boyfriend says, "Do you want to know my secret, or do you want to break up?"]] ] = 
    {text = [[Your boyfriend says, "Do you want to know my secret, or do you want to break up?"]],
    x = 0.63396778916545, y = 0.70068359375,
    width = 557.55102040816, height = 471.88940092166,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[stack traceback:
	SimpleButtons_B:269: in function 'button'
	uiPieces:131: in function 'choice'
	CharlotteGame:203: in function 'charlotteStart'
	Main:37: in global '_wrap_draw'
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[drink it]],
    x = 0.76836581709145, y = 0.31666666666667,
    width = 557.55102040816, height = 120.47058823529,
    action = simpleButtons.defaultButtonAction
}

simpleButtons.ui[ [[RosiesGame,rosieStart,64]] ] = 
    {text = [[exit]],
    x = 0.25658857979502, y = 0.59033203125,
    width = 130.764, height = 86.5702,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[stack traceback:
	SimpleButtons_B:269: in function 'button'
	uiPieces:120: in function 'textArea'
	CharlotteGame:198: in function 'charlotteStart'
	Main:37: in global '_wrap_draw'
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[You woke up.

What do you want to do with your coffee?]],
    x = 0.76836581709145, y = 0.63333333333333,
    width = 557.55102040816, height = 471.88940092166,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[stack traceback:
	SimpleButtons_B:269: in function 'button'
	uiPieces:131: in function 'choice'
	CharlotteGame:204: in function 'charlotteStart'
	Main:37: in global '_wrap_draw'
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[save it for later]],
    x = 0.76836581709145, y = 0.18333333333333,
    width = 557.55102040816, height = 120.47058823529,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[stack traceback:
	...
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[i]],
    x = 0.13743289409468, y = 0.91666666666667,
    width = 82.764, height = 85.5702,
    action = simpleButtons.defaultButtonAction
}
...
simpleButtons.ui[ [[stack traceback:
	...
	SupportedOrientations:262: in function <SupportedOrientations:244>]] ] = 
    {text = [[heroineStart]],
    x = 0.31859070464768, y = 0.58333333333333,
